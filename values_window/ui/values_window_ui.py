...
class Ui_valores_window(object):
    def setupUi(self, valores_window):
        if not valores_window.objectName():
            valores_window.setObjectName("valores_window")
        ...
        self.le_general_value.setObjectName("le_general_value")
        ...
        self.chb_ipun.setObjectName("chb_ipun")
        ...
        self.chb_iborx.setObjectName("chb_iborx")
        ...
        self.chb_iborz.setObjectName("chb_iborz")
        ...
        self.chb_ibory.setObjectName("chb_ibory")
        ...
        self.le_ixyz.setObjectName("le_ixyz")
        ...
        self.le_kblock.setObjectName("le_kblock")
        ...
        self.chb_local_value.setObjectName("chb_local_value")
        ...
        self.pb_add_region.setObjectName("pb_add_region")
        ...
        self.pb_remove_region.setObjectName("pb_remove_region")
        ...
        self.lw_regions.setObjectName("lw_regions")
        ...
        self.le_local_value.setObjectName("le_local_value")
        ...
        self.le_local_sp.setObjectName("le_local_sp")
        ...
        self.le_local_k.setObjectName("le_local_k")
        ...
        self.le_y_lon.setObjectName("le_y_lon")
        ...
        self.le_x_start.setObjectName("le_x_start")
        ...
        self.le_y_start.setObjectName("le_y_start")
        ...
        self.le_x_lon.setObjectName("le_x_lon")
        ...
        self.le_z_start.setObjectName("le_z_start")
        ...
        self.le_z_lon.setObjectName("le_z_lon")
    ...
    def retranslateUi(self, valores_window):
        valores_window.setWindowTitle(QCoreApplication.translate("valores_window", "Valores - PrePRODIC3D", None))
        self.groupBox.setTitle(QCoreApplication.translate("valores_window", "Valores", None))
        self.groupBox_2.setTitle(
            QCoreApplication.translate("valores_window", "Valores generales del dominio por variable", None)
        )
        ...
        ___qlistwidgetitem.setText(QCoreApplication.translate("valores_window", "Temperatura", None))
        self.lw_variables.setSortingEnabled(__sortingEnabled)

        self.groupBox_4.setTitle("")
        self.label_2.setText(QCoreApplication.translate("valores_window", "Conductividad", None))
        self.label_15.setText(QCoreApplication.translate("valores_window", "Extrapola excepto", None))
        self.groupBox_11.setTitle("")
        self.chb_ipun.setText(QCoreApplication.translate("valores_window", "Esquinas", None))
        self.groupBox_10.setTitle("")
        self.chb_iborx.setText(QCoreApplication.translate("valores_window", "X", None))
        self.chb_iborz.setText(QCoreApplication.translate("valores_window", "Z", None))
        self.chb_ibory.setText(QCoreApplication.translate("valores_window", "Y", None))
        self.label.setText(QCoreApplication.translate("valores_window", "Valor general", None))
        self.label_16.setText(QCoreApplication.translate("valores_window", "Ind. Impresi\u00f3n", None))
        self.label_17.setText(QCoreApplication.translate("valores_window", "Ind. correc. bloque", None))
        self.groupBox_5.setTitle(QCoreApplication.translate("valores_window", "Flotabilidad", None))
        self.label_3.setText(QCoreApplication.translate("valores_window", "Coef. exp. term.", None))
        self.label_4.setText(QCoreApplication.translate("valores_window", "Gravedad", None))
        self.label_5.setText(QCoreApplication.translate("valores_window", "\u00c1ngulo", None))
        self.checkBox.setText(QCoreApplication.translate("valores_window", "Activar flotabilidad", None))
        self.chb_local_value.setText(
            QCoreApplication.translate(
                "valores_window", "Para aplicar valores locales para alguna variable, active la siguiente casilla", None
            )
        )
        self.groupBox_6.setTitle(QCoreApplication.translate("valores_window", "Valores locales por variable", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("valores_window", "Regiones", None))
        self.pb_add_region.setText(QCoreApplication.translate("valores_window", "Agregar una regi\u00f3n", None))
        self.pb_remove_region.setText(
            QCoreApplication.translate("valores_window", "Eliminar \u00faltima regi\u00f3n", None)
        )
        ...
        ___qlistwidgetitem1.setText(QCoreApplication.translate("valores_window", "Region 1", None))
        self.lw_regions.setSortingEnabled(__sortingEnabled1)

        self.label_6.setText(QCoreApplication.translate("valores_window", "Valor local", None))
        self.label_7.setText(QCoreApplication.translate("valores_window", "Sc", None))
        self.label_8.setText(QCoreApplication.translate("valores_window", "Sp", None))
        self.label_9.setText(QCoreApplication.translate("valores_window", "k local", None))
        self.chb_fixed_value.setText(QCoreApplication.translate("valores_window", "Valor fijo", None))
        self.chb_linear_source.setText(QCoreApplication.translate("valores_window", "Fuente lineal", None))
        self.groupBox_8.setTitle(
            QCoreApplication.translate("valores_window", "Conformaci\u00f3n de la regi\u00f3n", None)
        )
        ...
        ___qlistwidgetitem2.setText(QCoreApplication.translate("valores_window", "Volumen 1", None))
        self.lw_volumes.setSortingEnabled(__sortingEnabled2)

        self.pb_add_volume.setText(QCoreApplication.translate("valores_window", "Agregar un volumen", None))
        self.pb_remove_volume.setText(
            QCoreApplication.translate("valores_window", "Eliminar \u00faltimo volumen", None)
        )
        self.groupBox_9.setTitle("")
        self.label_10.setText(QCoreApplication.translate("valores_window", "Longitud", None))
        self.label_12.setText(QCoreApplication.translate("valores_window", "X", None))
        self.label_13.setText(QCoreApplication.translate("valores_window", "Y", None))
        self.label_11.setText(QCoreApplication.translate("valores_window", "Inicio", None))
        self.label_14.setText(QCoreApplication.translate("valores_window", "Z", None))
