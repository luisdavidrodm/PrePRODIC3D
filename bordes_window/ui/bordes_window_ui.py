...
class Ui_bordes_window(object):
    ...
    def retranslateUi(self, bordes_window):
        ...
        self.gb_tipo_segment.setTitle(QCoreApplication.translate("bordes_window", u"Tipo de borde", None))
        ...
        self.label_3.setText(QCoreApplication.translate("bordes_window", u"Parches", None))
    # retranslateUi
