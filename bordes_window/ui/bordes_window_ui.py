...
################################################################################
## Form generated from reading UI file 'bordes_windowMOUSud.ui'
##
...
class Ui_bordes_window(object):
    def setupUi(self, bordes_window):
        ...
        self.chb_ex_value.setWhatsThis(
            "Activa esta opci\u00f3n para iterar este valor en la posici\u00f3n vecina del borde seleccionado en vez de iterar en el borde mismo."
        )
        ...
        self.chb_ex_k.setObjectName("chb_ex_k")
        # if QT_CONFIG(whatsthis)
        self.chb_ex_k.setWhatsThis(
            "Activa esta opci\u00f3n para iterar este valor en la posici\u00f3n vecina del borde seleccionado en vez de iterar en el borde mismo."
        )
        # endif // QT_CONFIG(whatsthis)

        self.gridLayout_4.addWidget(self.chb_ex_k, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.le_k, 1, 0, 1, 1)

        self.le_fracmass = QLineEdit(self.groupBox_4)
        self.le_fracmass.setObjectName("le_fracmass")
        self.le_fracmass.setEnabled(False)
        self.le_fracmass.setAlignment(Qt.AlignCenter)

        self.gridLayout_4.addWidget(self.le_fracmass, 4, 0, 1, 1)
        ...
        self.chb_exclude_borders.setObjectName("chb_exclude_borders")
        ...
        self.le_vertical_end.setObjectName("le_vertical_end")
        ...
        self.cb_ex_vertical_end.addItem("")
        self.cb_ex_vertical_end.addItem("")
        self.cb_ex_vertical_end.setObjectName("cb_ex_vertical_end")
        ...
        self.cb_ex_vertical_start.addItem("")
        self.cb_ex_vertical_start.addItem("")
        self.cb_ex_vertical_start.setObjectName("cb_ex_vertical_start")
        ...
        self.cb_ex_transversal_start.addItem("")
        self.cb_ex_transversal_start.addItem("")
        self.cb_ex_transversal_start.setObjectName("cb_ex_transversal_start")
        ...
        self.cb_ex_transversal_end.addItem("")
        self.cb_ex_transversal_end.addItem("")
        self.cb_ex_transversal_end.setObjectName("cb_ex_transversal_end")
        ...
        self.le_transversal_end.setObjectName("le_transversal_end")
    ...
    def retranslateUi(self, bordes_window):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("bordes_window", "Variables", None))
        ...
        self.chb_ex_value.setToolTip(
            QCoreApplication.translate(
                "bordes_window",
                "<html><head/><body><p>Activa esta opci\u00f3n para iterar este<br/>valor en la posici\u00f3n vecina del borde<br/>seleccionado en vez de iterar en el<br/>borde mismo.</p></body></html>",
                None,
            )
        )
        ...
        self.label.setText(QCoreApplication.translate("bordes_window", "Conductividad", None))
        # if QT_CONFIG(tooltip)
        self.chb_ex_k.setToolTip(
            QCoreApplication.translate(
                "bordes_window",
                "<html><head/><body><p>Activa esta opci\u00f3n para iterar este<br/>valor en la posici\u00f3n vecina del borde<br/>seleccionado en vez de iterar en el<br/>borde mismo.</p></body></html>",
                None,
        ...
        self.label_6.setText(QCoreApplication.translate("bordes_window", "Fracci\u00f3n m\u00e1sica", None))
        self.le_k.setPlaceholderText("")
        self.le_fracmass.setText(QCoreApplication.translate("bordes_window", "1", None))
        ...
        self.pb_addpatch.setText(QCoreApplication.translate("bordes_window", "Agregar un parches", None))
        self.pb_rempatch.setText(QCoreApplication.translate("bordes_window", "Eliminar un parches", None))
        self.label_2.setText(QCoreApplication.translate("bordes_window", "Bordes", None))
        # if QT_CONFIG(tooltip)
        self.chb_exclude_borders.setToolTip(
            QCoreApplication.translate(
                "bordes_window",
                "<html><head/><body><p>Activa esta opci\u00f3n para excluir<br/>los bordes inicial y final del dominio<br/>para cada iteraci\u00f3n en el parche<br/>seleccionado, independientemente<br/>de las limitantes por coordenadas.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(whatsthis)
        self.chb_exclude_borders.setWhatsThis(
            QCoreApplication.translate(
                "bordes_window",
                "Activa esta opci\u00f3n para excluir los bordes inicial y final del dominio para cada iteraci\u00f3n en el parche seleccionado, independientemente de las limitantes por coordenadas.",
                None,
            )
        )
        # endif // QT_CONFIG(whatsthis)
        self.chb_exclude_borders.setText(QCoreApplication.translate("bordes_window", "V.C. Excluir bordes", None))
        self.groupBox_2.setTitle("")
        self.cb_ex_vertical_end.setItemText(0, "")
        self.cb_ex_vertical_end.setItemText(1, QCoreApplication.translate("bordes_window", "<", None))
        self.cb_ex_vertical_end.setItemText(2, QCoreApplication.translate("bordes_window", "\u2264", None))

        self.cb_ex_vertical_start.setItemText(0, "")
        self.cb_ex_vertical_start.setItemText(1, QCoreApplication.translate("bordes_window", ">", None))
        self.cb_ex_vertical_start.setItemText(2, QCoreApplication.translate("bordes_window", "\u2265", None))

        self.lb_transversal.setText(QCoreApplication.translate("bordes_window", "Y", None))
        self.cb_ex_transversal_start.setItemText(0, "")
        self.cb_ex_transversal_start.setItemText(1, QCoreApplication.translate("bordes_window", ">", None))
        self.cb_ex_transversal_start.setItemText(2, QCoreApplication.translate("bordes_window", "\u2265", None))

        self.cb_ex_transversal_end.setItemText(0, "")
        self.cb_ex_transversal_end.setItemText(1, QCoreApplication.translate("bordes_window", "<", None))
        self.cb_ex_transversal_end.setItemText(2, QCoreApplication.translate("bordes_window", "\u2264", None))
        ...
        self.label_3.setText(QCoreApplication.translate("bordes_window", "Parches", None))
