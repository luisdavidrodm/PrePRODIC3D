...
class Ui_variables_window(object):
    def setupUi(self, variables_window):
        ...
        self.chb_ksolve12 = QCheckBox(self.gb_variables2)
        self.chb_ksolve12.setObjectName(u"chb_ksolve12")

        self.gridLayout.addWidget(self.chb_ksolve12, 12, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.chb_kprint12, 12, 4, 1, 1)
        ...
        self.le_relax12 = QLineEdit(self.gb_variables2)
        self.le_relax12.setObjectName(u"le_relax12")
        self.le_relax12.setAlignment(Qt.AlignCenter)

        self.gridLayout.addWidget(self.le_relax12, 12, 5, 1, 1)
    ...
    def retranslateUi(self, variables_window):
        ...
        self.chb_ksolve12.setText(QCoreApplication.translate("variables_window", u"Resolver", None))
