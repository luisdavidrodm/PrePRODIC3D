...
################################################################################
## Form generated from reading UI file 'variables_windowGUWHuF.ui'
##
...
class Ui_variables_window(object):
    def setupUi(self, variables_window):
        ...
        self.label_21 = QLabel(self.gb_variables1)
        ...
        self.le_tol = QLineEdit(self.gb_variables1)
        self.le_tol.setObjectName(u"le_tol")

        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.le_tol)
